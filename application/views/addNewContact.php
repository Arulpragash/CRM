        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <div class="row">
                    <div id="addContactSuccess" style="display:none;"> </div>
                        <!-- left column -->
                        <div class="col-md-12">
                            <!-- general form elements -->
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Enter Contact Details Below</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <?php $attributes = array('id' => 'addContactForm'); ?>
                                <?php echo form_open_multipart('main/addContact',$attributes);?>
                                    <div class="box-body">
