            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="<?php echo base_url(); ?>index.php/Home">Add Activity</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row">
                    <div id="addActivitySuccess" style="display:none;"> </div>
                        <!-- left column -->
                        <div class="col-md-12">
                            <!-- general form elements -->
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Enter Activity Details Below</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <?php $attributes = array('id' => 'addActivityForm'); ?>
                                <?php echo form_open_multipart('main/addActivity',$attributes);?>
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="outcome" placeholder="Outcome" name="outcome">
                                        </div>
                                        <div class="form-group">
